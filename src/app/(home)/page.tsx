  ...
  return (
    <main className="relative min-h-[100dvh] items-center justify-center bg-transparent px-8 pt-8">
      ...
      <div className={"w-full"}>
        <BlurFadeText className={"my-2.5 text-4xl font-bold text-black dark:text-white"} delay={config.initialAnimationDelay} yOffset={8} animateByCharacter={true} text={"Hey, I'm Jake 👋"} />
        {config.description.split("\n").map((line, i) => (
          <BlurFadeText key={i} className={"my-2.5 text-base font-normal text-black dark:text-white"} delay={config.initialAnimationDelay * 2 + 1 * 0.05} text={line} />
        ))}
      </div>
      ...
      <div className={"w-full"}>
        ...
        <BlurFadeText className={"mb-2.5 text-base font-normal text-black dark:text-white"} delay={config.initialAnimationDelay * 4} text={'You can contact me by either sending an email to <a href="mailto:hello@jakemc.dev">hello@jakemc.dev</a>, or by any of the socials listed at the bottom of this page.'} />
      </div>
